...
# Level Detection
LEVEL_MODEL_PATH = "<your_path>/models/iv-fluids-level-detection-model.h5"
MODEL_IMG_SIZE = 32
...
if __name__ == "__main__":
    VIDEO_PATH = "<your_path>/testing/integrated/final.mp4"
    YOLO_WEIGHTS = "<your_path>/models/drop_detector_yolo.pt"       # CHANGE THIS
