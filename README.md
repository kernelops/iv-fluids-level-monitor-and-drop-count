...
### Optional: SMS Alerts
For SMS notifications in the level detection system:
```bash
pip install twilio
```
...
- `ENABLE_SMS_ALERT`: Enable SMS notifications (default: False)
...
To enable SMS notifications in the level detection system:

1. Sign up for a Twilio account
2. Update the configuration in `level_alert_main.py`:
```python
ENABLE_SMS_ALERT = True
TWILIO_ACCOUNT_SID = "your_account_sid"
TWILIO_AUTH_TOKEN = "your_auth_token"
TWILIO_FROM = "+1234567890"  # your Twilio number
TWILIO_TO = "+1987654321"    # destination number
```
